...
namespace BotCore.Auth
{
    ...
    public sealed class CachedTopstepAuth(Func<CancellationToken, Task<string>> fetchJwt) : ITopstepAuth
    {
        private readonly Func<CancellationToken, Task<string>> _fetchJwt = fetchJwt;
